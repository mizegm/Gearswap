...
function init_gear_sets()
    ...
    sets.idle = {
		...
		head={ name="Viti. Chapeau +3", augments={'Enfeebling Magic duration','Magic Accuracy',}},
		body="Jhakri Robe +2",
		hands={ name="Chironic Gloves", augments={'CHR+2','"Cure" spellcasting time -8%','"Refresh"+2',}},
		legs={ name="Carmine Cuisses +1", augments={'Accuracy+20','Attack+12','"Dual Wield"+6',}},
		feet={ name="Chironic Slippers", augments={'"Store TP"+6','Crit.hit rate+2','"Refresh"+1','Accuracy+12 Attack+12','Mag. Acc.+15 "Mag.Atk.Bns."+15',}},
		...
		back={ name="Sucellos's Cape", augments={'DEX+20','Accuracy+20 Attack+20','"Store TP"+10','Damage taken-5%',}},
	}
	...
	sets.weapons.Idle = {main="Bolelabunga", sub="Genmei Shield"} 
	--sets.weapons.Idle.Town = {main="Naegling", sub={ name="Thibron", augments={'TP Bonus +1000',}}}
end
